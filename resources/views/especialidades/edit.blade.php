...
<title>Editar Especialidad</title>
    <div class="animated-header text-center my-4">
        <h1 class="text-primary fw-bold">Editar Especialidad</h1>
    </div>
    ...
    <div class="container mt-4">
        ...
        <!-- Formulario -->
        <form id="miFormulario" action="{{ route('especialidades.update', $especialidad->id) }}" method="POST" class="shadow-lg p-4" style="background-color: #ffffff; border-radius: 15px;">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3">
                ...
                <input type="text" id="nombre" name="nombre" class="form-control" value="{{ $especialidad->nombre }}" placeholder="Ingresa el nombre" style="border-radius: 10px; border: 1px solid #ced4da;">
            </div>

            <!-- Descripción -->
            <div class="mb-3">
                <label for="descripcion" class="form-label fw-bold text-secondary">Descripción:</label>
                <input type="text" id="descripcion" name="descripcion" class="form-control" value="{{ $especialidad->descripcion }}" placeholder="Ingresa la descripción" style="border-radius: 10px; border: 1px solid #ced4da;">
            </div>
