...
<title>Info de la Especialidad</title>
    <div class="animated-header text-center my-4">
        <h1 class="text-primary fw-bold">Información de la Especialidad</h1>
    </div>
    ...
    <div class="container mt-4">
        ...
        <div class="card shadow-lg" style="border-radius: 15px; background-color: #ffffff;">
            ...
            <div class="card-body" style="color: #333333; font-size: 1.1rem;">
                <p><strong>Nombre:</strong> <span class="text-primary">{{ $especialidad->nombre }}</span></p>
                <p><strong>Descripción:</strong> <span class="text-success">{{ $especialidad->descripcion }}</span></p>
            </div>
        </div>
    </div>
@endsection
